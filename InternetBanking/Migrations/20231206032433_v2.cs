        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerPersonalId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Accounts_Customers_CustomerPersonalId1",
                        column: x => x.CustomerPersonalId1,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HelpRequests_Customers_CustomerPersonalId1",
                        column: x => x.CustomerPersonalId1,
                        principalTable: "Customers",
                        principalColumn: "PersonalId");
                    table.ForeignKey(
                        name: "FK_HelpRequests_Employees_EmployeeId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpireDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    CustomerPersonalId = table.Column<int>(type: "int", nullable: true),
                    EmployeeId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "AccountNumber");
                    table.ForeignKey(
                        name: "FK_Services_Customers_CustomerPersonalId1",
                        column: x => x.CustomerPersonalId1,
                        principalTable: "Customers",
                        principalColumn: "PersonalId");
                    table.ForeignKey(
                        name: "FK_Services_Employees_EmployeeId1",
                        column: x => x.EmployeeId1,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_CustomerPersonalId1",
                table: "Accounts",
                column: "CustomerPersonalId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HelpRequests_CustomerPersonalId1",
                table: "HelpRequests",
                column: "CustomerPersonalId1");

            migrationBuilder.CreateIndex(
                name: "IX_HelpRequests_EmployeeId1",
                table: "HelpRequests",
                column: "EmployeeId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_CustomerPersonalId1",
                table: "Services",
                column: "CustomerPersonalId1");

            migrationBuilder.CreateIndex(
                name: "IX_Services_EmployeeId1",
                table: "Services",
                column: "EmployeeId1");
